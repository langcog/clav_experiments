...
function getWordList(list_number) {
    ...
    var php_url = "http://langcog.stanford.edu/cgi-bin/NPM_CLAV/clav_filereading2.php";
...
function submitData() {
    ...
    $.post("http://langcog.stanford.edu/cgi-bin/NPM_CLAV/clav_ipad_2_submit.php", {result_file_path : outfile, postresult_array : experiment_result_array}); //posts the results to the server using php
