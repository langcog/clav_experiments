...
var age_entry;
var gender_entry;
var pauseTime = 1000; //governs the animation look
...
/*Function: getTrialType
  ...
  */
  function getTrialType () {
	...
	var age_string = document.getElementById("age_entry").value;
	age_entry = age_string;
	console.log("age of child is " + age_entry);
	var gender_string = document.getElementById("gender_entry").value;
	gender_entry = gender_string;
	console.log("child's gender is " + gender_entry);
...
var experiment = { //var containing the experiment, though everything is called from within it
	...
	/*Function: run
  	...
  	run : function(data) { //Will be the main display function
        ...
        var picID_string = picID.substring(0,picID.length - 3);
